...
$sql_benhnhan = "UPDATE benhnhan SET hotenbn = '$hotenbn',  sdtbn = '$sdtbn',  gioitinhbn = '$gioitinhbn',
                                     namsinhbn = '$namsinhbn', diachibn = '$diachibn',  nhommau = '$nhommau' WHERE emailbn = '$emailbn'";
