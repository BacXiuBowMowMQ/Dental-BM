...
$sql_phieukhambenh = "UPDATE phieukhambenh SET hotenbn = '$hotenbn',  sdtbn = '$sdtbn',  gioitinhbn = '$gioitinhbn', namsinhbn = '$namsinhbn', diachibn = '$diachibn' WHERE emailbn = '$emailbn'";
