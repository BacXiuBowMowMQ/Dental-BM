                            ...
                            <div class="product-status-wrap">
                                ...
                                <div class="asset-inner">
                                    <table>
                                        ...
                                        $sql = "SELECT MADICHVU, TENDICHVU, GIADV, MOTADV FROM dichvu";
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>" . $row["MOTADV"] . "</td>";
                                               
                                                                                    
                                                echo "<td>
                                               <button class='pd-setting-ed' onclick=\"editService('" . $row['MADICHVU'] . "', '" . $row['TENDICHVU'] . "', '" . $row['GIADV'] . "', '" . $row['MOTADV'] . "')\">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="editServiceForm">
                                ...
                                <div class="form-group">
                                    <label for="editedServiceDescribe">Mô tả dịch vụ:</label>
                                    <input type="text" id="editedServiceDescribe" name="editedServiceDescribe" class="form-control">
                                </div>
...
<script>
    ...
    // Chinh sua dich vu
    function editService(madichvu, tendichvu, giadv, motadv) {          
    // Điền thông tin dịch vụ vào form chỉnh sửa
    ...
    document.getElementById('editedServiceDescribe').value = motadv;
...
function saveEditedService() {
    ...
    var motadv = document.getElementById('editedServiceDescribe').value;

    // Gửi yêu cầu cập nhật dịch vụ qua AJAX
    $.ajax({
        type: "POST",
