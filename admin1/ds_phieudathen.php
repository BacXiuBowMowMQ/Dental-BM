                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <!-- <div class="add-product">
                                <a href="them_cuochen.php">Tạo cuộc hẹn mới</a>
                            </div> -->
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td>
                                                    ...
                                                    if ($row["XULY"] == 0) {
                                                        echo '<img src="img/waiting.png" alt="Chưa hoàn thành" style="width:50%;"/>';
                                                    } else {
                                                        echo '<img src="img/check.png" alt="Hoàn thành" style="width:50%;"/>';
                                                    }
                                                    echo "</div>
                                                        </td>";
