...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $loaithuoc = $_POST['loaithuoc'];
     ...
     $sql_check_mathuoc = "SELECT * FROM thuoc WHERE mathuoc = '$mathuoc'";
     $result_check_mathuoc = $conn->query($sql_check_mathuoc);
 
     if ($result_check_mathuoc->num_rows > 0) {
         // Nếu giá trị mathuoc đã tồn tại, hiển thị thông báo lỗi và ngăn việc thêm bản ghi mới
         echo '<script language="javascript">alert("Mã thuốc đã tồn tại.");</script>';
     } else {
         // Nếu giá trị mathuoc chưa tồn tại, thực hiện thêm bản ghi mới vào bảng dichvu
         $sql_dichvu = "INSERT INTO thuoc (MATHUOC, TENTHUOC, LOAITHUOC) VALUES ('$mathuoc', '$tenthuoc', '$loaithuoc')";
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Thêm thuốc</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-payment-inner-st">
                    <ul id="myTabedu1" class="tab-review-design">
                        <li class="active"><a href="#themdv">Thêm thuốc</a></li>
                    </ul>
                                        ...
                                        <div id="dropzone1" class="pro-ad addcoursepro">
                                            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="loaithuoc" name="loaithuoc" required>
                                                </div>
