...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $idphieu = "ID" . time() . "-" . $emailbn . "-" . $emailnv;

    // Chèn dữ liệu vào bảng `phieudatlich` trước
    $sql_phieudatlich = "INSERT INTO phieudatlich (IDPHIEU, EMAILNV, EMAILBN, NGAYDAT, GIODAT, TRANGTHAIPDL)
            VALUES ('$idphieu', '$emailnv', '$emailbn', '$ngayhen', '$giohen', 0)";

    if ($conn->query($sql_phieudatlich) === TRUE) {
        // Thêm các MADICHVU vào bảng `pdldv`
        if (!is_array($madichvu)) {
            $madichvu = array($madichvu);
        }

        foreach ($madichvu as $madv) {
            $sql_pdldv = "INSERT INTO pdldv (IDPHIEU, MADICHVU) VALUES ('$idphieu', '$madv')";
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <ul class="breadcome-menu">
                                        ...
                                        <li><span class="bread-blod">Tạo cuộc hẹn</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#thembs">Tạo cuộc hẹn</a></li>
                                                                    ...
                                                                    <label for="">Giờ hẹn</label>
                                                                      ...
                                                                      <select  name='giohen'class="form-control bg-light border-0 datetimepicker-input"
                                                                        placeholder="Giờ hẹn" style="height: 55px;" >
                                                                            <option value="none" selected="" disabled="">Chọn giờ hẹn</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light">Tạo lịch hẹn</button>
                                                                </div>
