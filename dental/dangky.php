    ...
    <div class="card border-light-subtle shadow-sm">
      <div class="row g-0">
        <div class="col-12 col-md-6">
          <img class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" src="./img/dangky.jpg" alt="BootstrapBrain Logo">
        </div>
        <div class="col-12 col-md-6">
          <div class="card-body p-3 p-md-4 p-xl-5">
            <div class="row">
              <div class="col-12">
                <div class="mb-5">
                  <h2 class="h3">Đăng Ký Tài Khoản</h2>
                  <h3 class="fs-6 fw-normal text-secondary m-0">Nhập thông tin của bạn để đăng ký</h3>
                </div>
              </div>
            </div>
            <form action="./configs/dangky.php" method="POST">
              <div class="row gy-3 gy-md-4 overflow-hidden">
               
                <div class="col-12">
                  <label for="lastName" class="form-label">Họ và Tên <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" name="ten" id="lastName" placeholder="" required>
                </div>
                <div class="col-12">
                ...
                <div class="col-md-6 mt-2">
                  ...
                  <input type="password" class="form-control"  name="psw" id="password" value="" required>
                </div>

                <div class="col-md-6 mt-2">
                    <label for="inputPassword4" class="form-label">Nhập lại mật khẩu <span class="text-danger">*</span></label>
                ...
                <div class="col-md-12 mt-2">
                    <label for="inputtext4" class="form-label">Địa chỉ<span class="error"></span></label>
                ...
                <div class="col-12">
                  <div class="form-check">
                    ...
                    <label class="form-check-label text-secondary" for="iAgree">
                      Tôi đồng ý <a href="#!" class="link-primary text-decoration-none">chính sách phòng khám BM</a>
                    </label>
                  </div>
                </div>
                <div class="col-12">
                  <div class="d-grid">
                    <button class="btn bsb-btn-xl btn-primary" type="submit" name="sb_dk">Đăng Ký</button>
                  </div>
                </div>
              </div>
            </form>
            <div class="row">
              <div class="col-12">
                ...
                <p class="m-0 text-secondary text-center">Bạn đã có tài khoản? <a href="login.php" class="link-primary text-decoration-none">Đăng Nhập</a></p>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
